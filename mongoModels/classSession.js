...
const classSessionSchema = new mongoose.Schema({
  ...
  courseId: { type: mongoose.Schema.Types.ObjectId, ref: COURSE_MODEL_NAME, required: true },
  organizationId: { type: mongoose.Schema.Types.ObjectId, ref: ORGANIZATION_MODEL_NAME, required: true },
  classSessionStudentsIds: [{ type: mongoose.Schema.Types.ObjectId, ref: CLASS_SESSION_STUDENT_MODEL_NAME }],
});

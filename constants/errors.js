...
const ERRORS = {
  ...
  E409_3: { errorCode: 'E409_3', message: 'Invitation can only be resent to inactive users', status: 409 },
  E409_4: { errorCode: 'E409_4', message: 'Password reset is only available for active users', status: 409 },
  //422
